...
const HomePage = () => {
  ...
  useEffect(() => {
    async function getRooms() {
      try {
        const res = await axios.post(
          "http://localhost:3000/rooms/instructorRoom",
          {
            instructor_id: user_data?.id,
          }
        );
    ...
    if (user_data.role === "instructor") getRooms();
  }, [user_data.id]);
  ...
  useEffect(() => {
    ...
    if (user_data.role === "student") getStudentAttendance();
  }, []);
  ...
  useEffect(() => {
    async function getEnrollments() {
      try {
        const res = await axios.post(
          "http://localhost:3000/enrollment/studentEnrollment",
          {
    ...
    if (user_data.role === "student") getEnrollments();
  }, []);
                      ...
                      <div>
                        <form className="flex flex-col gap-10">
                          ...
                          <div className="flex justify-between">
                            ...
                            <Button
                              onClick={() =>
                                handleRoomCreation(`/room/${room_id}`)
                              }
                            >
                              Add Room
                            </Button>
