                ...
                <Card className="w-full max-w-2xl mx-auto">
                    ...
                    <CardContent>
                        <form onSubmit={handleSubmit} className="space-y-6">
                            <div className="space-y-2">
                                ...
                                <div className="flex items-center space-x-4">
                                    ...
                                    <Input
                                        ...
                                        className="h-15 file:mr-4 file:py-2 file:px-4 file:rounded-full file:border-0 file:cursor-pointer file:text-sm file:font-semibold file:bg- file:text-primary-foreground hover:file:bg-"
                                    />
                                </div>
                            </div>
                            ...
                            <Button type="submit" className="w-full bg-primary hover:bg-[#4338CA] text-background">
                                Save Changes
                            </Button>
                        </form>
                    </CardContent>
